...
public class HanhDong extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hanhdong);

        android.support.v7.widget.Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle(R.string.phim_h_nh_ng);
        ...
        db.collection("movies").whereArrayContains("Category","Hành động")
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    gridMovieAdapter = new ListMovieAdapter(HanhDong.this,R.layout.grid_movie_items,arrayMovie);
        ...
        gridMovie.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent1 = new Intent(HanhDong.this,ChiTietPhim.class);
                intent1.putExtra("movieTitle",arrayMovie.get(position).getTitle());
                startActivity(intent1);
                //Toast.makeText(HanhDong.this, arrayMovie.get(position).getTitle(), Toast.LENGTH_SHORT).show();
            }
        });
    }
