...
public class TatCa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tatca);
        android.support.v7.widget.Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle(R.string.tat_ca_phim);
        ...
        db.collection("movies")
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    gridMovieAdapter = new ListMovieAdapter(TatCa.this,R.layout.grid_movie_items,arrayMovie);
        ...
        gridMovie.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent1 = new Intent(TatCa.this,ChiTietPhim.class);
                intent1.putExtra("movieTitle",arrayMovie.get(position).getTitle());
                startActivity(intent1);
                //Toast.makeText(TatCa.this, arrayMovie.get(position).getTitle(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
